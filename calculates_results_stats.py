...
def calculates_results_stats(results_dic):
    ...
    # this function 
    # create the dictionary to hold the statistics
    ...
    for key in results_dic:
        # increment correct breed E
        # pet label and classifier label must match
        if results_dic[key][3] == 1 and results_dic[key][2] == 1:
                results_stats_dic['n_correct_breed'] +=1
        # increment dog images
        # pet label is a dog
        if results_dic[key][3] == 1:
                results_stats_dic['n_dogs_img'] +=1   
        # increment not dog imgs
        # number of correct not dog matches
        if results_dic[key][3] == 0 and results_dic[key][4] == 0:
               results_stats_dic['n_correct_notdogs'] +=1
        # increment numbet of matches
        # number of correct matches
        if results_dic[key][2] == 1:
               results_stats_dic['n_match'] += 1
        # increment correct dog matches
